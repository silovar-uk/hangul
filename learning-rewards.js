...
function enhanceResult() {
  ...
  // Confusion practice already owns the learning reflection with WHAT CHANGED.
  // Keep one result story instead of stacking a generic reward summary beneath it.
